  ...
  return (
    <Folder name="Talks">
      ...
      <Composition
        ...
        schema={DevQuestSchema}
        defaultProps={{
          title:
            "Un donjon, deux donjons, trois donjons... Et si on automatisait la génération ?",
          speakers: [
            {
              name: "Florian Forestier",
              picture:
                "https://cdn.bsky.app/img/avatar/plain/did:plc:qxjqqquraxm6u4gdlptoqivb/bafkreiaoubwec3gwmzh4g5vijxf6n2lcovwh4y5rdek4pufjqerfzrhl2q@jpeg",
            },
            {
              name: "Sylvain Gougouzian",
              picture: "https://gouz.dev/gouz.jpg",
            },
          ],
          track: "Observatoire",
          start: "2026-06-12T15:00:00.000Z",
          categories: ["Méthodo & Architecture"],
        }}
      />
    </Folder>
  );
